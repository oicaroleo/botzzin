...
const STATUS_CFG: Record<string, { label: string; color: string; bg: string }> = {
  ...
  pix_generated: { label: 'PIX Gerado', color: '#9293C9', bg: 'rgba(146,147,201,0.08)'  },
  generated_pix: { label: 'PIX Gerado', color: '#9293C9', bg: 'rgba(146,147,201,0.08)'  },
  paid:          { label: 'Pagou',      color: '#6667AB', bg: 'rgba(102,103,171,0.08)'  },
          ...
          <tbody>
            {leads.map((lead) => {
              ...
              return (
                <tr key={lead.id}>
                  <td>
                    <div style={{ fontWeight: 600, fontSize: '13px', color: '#F0EEE9' }}>{name}</div>
                  ...
                  <td className="mono" style={{ fontSize: '13px', color: lead.lastPayment?.status === 'paid' ? '#6667AB' : '#505070' }}>
